...
public class OrderTest {
    ...
    public void Given_BadMenu_When_MenuIsRun_Then_ReAskMenu() {
        ...
        assertEquals("Vous avez choisi comme menu : poulet", output[11]);
    }
    @Test
    public void Given_ChikenWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous avez choisi comme accompagnement : frites", output[17]);
        assertEquals("Vous n'avez pas choisi de boisson parmi les choix proposés", output[23]);
        assertEquals("Vous avez choisi comme boisson : soda", output[29]);
    }
    @Test
    ...
    public void Given_VegetarianWithBadSideAndBadDrink_When_MenuIsRun_Then_ReAskSideAndDrink() {
        ...
        assertEquals("Vous avez choisi comme accompagnement : pas de riz", output[15]);
        assertEquals("Vous n'avez pas choisi de boisson parmi les choix proposés", output[21]);
        assertEquals("Vous avez choisi comme boisson : soda", output[27]);
    }
}